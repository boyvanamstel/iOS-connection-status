...
- (void)updateWithReachability: (Reachability*) curReach {
	...
	if(!_firstrun) {
		if(netStatus == ReachableViaWiFi || netStatus == ReachableViaWWAN) {
			NSLog(@"Connected");
			[self showAlert:NSLocalizedString(@"general_connectedtitle", @"Connected") message:NSLocalizedString(@"general_connectedmessage", @"You seem to be connected to the internet.")];
		} else {
			NSLog(@"Not connected");
			[self showAlert:NSLocalizedString(@"general_notconnectedtitle", @"Connected") message:NSLocalizedString(@"general_notconnectedmessage", @"You don't seem to be connected to the internet.")];
		}
	}
	_firstrun = NO;
}
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	...
	[self updateWithReachability: _hostReach];
